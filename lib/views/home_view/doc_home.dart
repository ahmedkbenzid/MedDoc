        ...
        child: Column(
          ...
          children: [
              ...
              children: [
                Expanded(
                  child: Container(
                    ...
                    child: Column(
                      children: [
                        Icon(Icons.calendar_today, size: 40, color: AppColors.blueColor),
                        10.heightBox,
                        AppStyles.bold(
                          title: "30",
                          color: AppColors.textColor,
                ...
                Expanded(
                  child: Container(
                    ...
                    child: Column(
                      children: [
                        Icon(Icons.cancel, size: 40, color: AppColors.blueColor),
                        10.heightBox,
                        AppStyles.bold(
                          title: "2",
                          color: AppColors.textColor,
            ...
            ListView.builder(
              ...
              physics: const ClampingScrollPhysics(), // permet le scroll par SingleChildScrollView
              itemCount: 5,
